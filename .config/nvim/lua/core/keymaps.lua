...
map("i", "<C-A-k>", "<ESC><CMD>m .-2<CR>==gi", { desc = "Move line(s) up" })
map("i", "<C-A-j>", "<ESC><CMD>m .+1<CR>==gi", { desc = "Move lines(s) down" })
map("n", "<C-A-k>", "<CMD>m .-2<CR>==", { desc = "Move line(s) up" })
map("n", "<C-A-j>", "<CMD>m .+1<CR>==", { desc = "Move line(s) down" })
map("v", "<C-A-k>", "<CMD>m '<-2<CR>gv=gv", { desc = "Move line(s) up" })
map("v", "<C-A-j>", "<CMD>m '>+1<CR>gv=gv", { desc = "Move line(s) down" })
